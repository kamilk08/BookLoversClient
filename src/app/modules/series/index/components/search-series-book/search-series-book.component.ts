...
@Component({
  selector: 'search-series-book',
  templateUrl: './search-series-book.component.html',
  styleUrls: ['./search-series-book.component.scss']
})
export class SearchSeriesBookComponent implements OnInit {
