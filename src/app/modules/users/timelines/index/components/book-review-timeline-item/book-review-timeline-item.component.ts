...
@Component({
  selector: 'book-review-timeline-item',
  templateUrl: './book-review-timeline-item.component.html',
  styleUrls: ['./book-review-timeline-item.component.scss'],
  providers: [TimelineItemDetailsService]
})
export class BookReviewTimeLineItemComponent implements OnInit {
