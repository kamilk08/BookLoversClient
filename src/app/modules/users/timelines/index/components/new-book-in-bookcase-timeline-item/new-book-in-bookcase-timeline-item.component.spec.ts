...
import { NewBookInBookcaseTimelineItemComponent } from './new-book-in-bookcase-timeline-item.component';

describe('NewBookInBookcaseTimelineItemComponent', () => {
  let component: NewBookInBookcaseTimelineItemComponent;
  let fixture: ComponentFixture<NewBookInBookcaseTimelineItemComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [NewBookInBookcaseTimelineItemComponent]
    })
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(NewBookInBookcaseTimelineItemComponent);
